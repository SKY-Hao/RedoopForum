            ...
            <nav class="navbar navbar-static-top" role="navigation">
                <div class="container">
                    <div class="navbar-header jeesns-logo">
                        ...
                        <a href="${basePath}/" class="navbar-brand"><img src="${basePath}${SITE_LOGO}" height="51px"/></a>
                    </div>
                    <div class="navbar-collapse collapse" id="navbar">
                        <ul class="nav navbar-nav" style="float: right;text-align: right;margin-right: -38px; margin-top: 15px;background-color: #252527;">
                            <li>
                        ...
                        <ul class="nav navbar-top-links navbar-right" style="position: relative; top:-18px; right:-280px;">
                                ...
                                <#else>
                                    <div class="btn-group nav-username">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li id="xq"><a href="${basePath}/member/">个人中心</a></li>
                                            <li id="xq"><a href="${basePath}/member/systemMessage">系统信息 ${(systemUnReadMessageNum > 0)?string("("+systemUnReadMessageNum+")","")}</a></li>
